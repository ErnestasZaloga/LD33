...
public class ParticleEmitter {
	...
	private float cullMin;
	private float cullMax;
	...
	public void setCulling(final float cullMin, final float cullMax) {
		this.cullMin = cullMin;
		this.cullMax = cullMax;
		this.culling = true;
	}
